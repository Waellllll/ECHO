...
class __TwigTemplate_0c5f1c851609520193fbd9ab65c4db1a extends Template
{
   ...
   <a href=\"";
        ...
        // line 36
        yield $this->env->getRuntime('Twig\Runtime\EscaperRuntime')->escape($this->extensions['Symfony\Bridge\Twig\Extension\RoutingExtension']->getPath("app_conseil_delete", ["id" => CoreExtension::getAttribute($this->env, $this->source, (isset($context["conseil"]) || array_key_exists("conseil", $context) ? $context["conseil"] : (function () { throw new RuntimeError('Variable "conseil" does not exist.', 36, $this->source); })()), "id", [], "any", false, false, false, 36)]), "html", null, true);
        yield "\" style=\"display:inline-block;\" onsubmit=\"return confirm('Are you sure you want to delete this item?');\">
            <input type=\"hidden\" name=\"_token\" value=\"";
        // line 37
        yield $this->env->getRuntime('Twig\Runtime\EscaperRuntime')->escape($this->env->getRuntime('Symfony\Component\Form\FormRenderer')->renderCsrfToken(("delete" . CoreExtension::getAttribute($this->env, $this->source, (isset($context["conseil"]) || array_key_exists("conseil", $context) ? $context["conseil"] : (function () { throw new RuntimeError('Variable "conseil" does not exist.', 37, $this->source); })()), "id", [], "any", false, false, false, 37))), "html", null, true);
        yield "\">
...
";
    ...
    {
        return array (  152 => 37,  148 => 36,  144 => 35,  140 => 34,  129 => 26,  122 => 22,  115 => 18,  108 => 14,  100 => 8,  87 => 7,  64 => 5,  41 => 3,);
    }
