...
class __TwigTemplate_7ceafd5c296bba09528a74a829bb564a extends Template
{
...
(isset($context["fileExt"]) || array_key_exists("fileExt", $context) ? $context["fileExt"] : (function () { throw new RuntimeError('Variable "fileExt" does not exist.', 53, $this->source); })()) == "pdf")) {
    ...
    <a href=\"";
        // line 67
        yield $this->env->getRuntime('Twig\Runtime\EscaperRuntime')->escape($this->extensions['Symfony\Bridge\Twig\Extension\RoutingExtension']->getPath("app_elearning_edit", ["id" => CoreExtension::getAttribute($this->env, $this->source, (isset($context["elearning"]) || array_key_exists("elearning", $context) ? $context["elearning"] : (function () { throw new RuntimeError('Variable "elearning" does not exist.', 67, $this->source); })()), "id", [], "any", false, false, false, 67)]), "html", null, true);
        yield "\">Edit</a>
...
";
    ...
    {
        return array (  224 => 69,  219 => 67,  215 => 66,  208 => 61,  204 => 59,  201 => 58,  195 => 56,  189 => 54,  187 => 53,  182 => 52,  179 => 51,  176 => 50,  174 => 49,  166 => 44,  159 => 40,  152 => 36,  145 => 32,  136 => 28,  129 => 24,  122 => 20,  115 => 16,  108 => 12,  100 => 6,  87 => 5,  64 => 3,  41 => 1,);
    }
...
{% block body %}
    ...
    <a href=\"{{ path('app_elearning_edit', {'id': elearning.id}) }}\">Edit</a>
