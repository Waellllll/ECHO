...
class __TwigTemplate_45e7f5d9991e1656b4b98463f969f62c extends Template
{
    ...
    <table class=\"table\">
        ...
        if (CoreExtension::getAttribute($this->env, $this->source, (isset($context["reclamation"]) || array_key_exists("reclamation", $context) ? $context["reclamation"] : (function () { throw new RuntimeError('Variable "reclamation" does not exist.', 33, $this->source); })()), "evidence", [], "any", false, false, false, 33)) {
            // line 34
            yield "                    <a href=\"";
            yield $this->env->getRuntime('Twig\Runtime\EscaperRuntime')->escape($this->extensions['Symfony\Bridge\Twig\Extension\AssetExtension']->getAssetUrl(("uploads/evidence/" . CoreExtension::getAttribute($this->env, $this->source, (isset($context["reclamation"]) || array_key_exists("reclamation", $context) ? $context["reclamation"] : (function () { throw new RuntimeError('Variable "reclamation" does not exist.', 34, $this->source); })()), "evidenceFile", [], "any", false, false, false, 34))), "html", null, true);
            ...
            <tr>
                ...
                <td>
                 {% if reclamation.evidence %}
                    <a href=\"{{ asset('uploads/evidence/' ~ reclamation.evidenceFile) }}\" target=\"_blank\">View Evidence</a>
                {% else %}
                    No file uploaded
                {% endif %}
...
{% endblock %}
", "reclamation/show.html.twig", "C:\\xampp1\\htdocs\\integration_workshop_user1\\templates\\reclamation\\show.html.twig");
    }
}
