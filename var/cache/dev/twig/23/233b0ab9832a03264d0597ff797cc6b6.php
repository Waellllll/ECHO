...
class __TwigTemplate_d3ab87b6c4b2ad786b17ac4bcc3f27e0 extends Template
{
        ...
        foreach ($context['_seq'] as $context["_key"] => $context["workshop"]) {
            ...
            yield " </td>
                <td>
                    <a href=\"";
            // line 39
            yield $this->env->getRuntime('Twig\Runtime\EscaperRuntime')->escape($this->extensions['Symfony\Bridge\Twig\Extension\RoutingExtension']->getPath("app_workshop_show", ["id" => CoreExtension::getAttribute($this->env, $this->source, $context["workshop"], "id", [], "any", false, false, false, 39)]), "html", null, true);
            yield "\">show</a>
                    <a href=\"";
            // line 40
            yield $this->env->getRuntime('Twig\Runtime\EscaperRuntime')->escape($this->extensions['Symfony\Bridge\Twig\Extension\RoutingExtension']->getPath("app_workshop_edit", ["id" => CoreExtension::getAttribute($this->env, $this->source, $context["workshop"], "id", [], "any", false, false, false, 40)]), "html", null, true);
            yield "\">edit</a>
...
";
    ...
    {
        return array (  203 => 53,  198 => 50,  189 => 46,  187 => 45,  177 => 40,  173 => 39,  166 => 37,  162 => 36,  158 => 35,  154 => 34,  150 => 33,  146 => 32,  142 => 31,  138 => 30,  134 => 29,  130 => 28,  127 => 27,  122 => 26,  100 => 6,  87 => 5,  64 => 3,  41 => 1,);
    }
...
{% endblock %}
", "workshop/index.html.twig", "C:\\Users\\OmarA\\OneDrive\\Bureau\\integration_workshop_user1\\templates\\workshop\\index.html.twig");
    }
}
