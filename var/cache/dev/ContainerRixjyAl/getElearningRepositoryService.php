 ...
 */
class getElearningRepositoryService extends App_KernelDevDebugContainer
{
    /**
     * Gets the private 'App\Repository\ElearningRepository' shared autowired service.
     *
     * @return \App\Repository\ElearningRepository
     */
    public static function do($container, $lazyLoad = true)
    {
        ...
        include_once \dirname(__DIR__, 4).''.\DIRECTORY_SEPARATOR.'src'.\DIRECTORY_SEPARATOR.'Repository'.\DIRECTORY_SEPARATOR.'ElearningRepository.php';

        return $container->privates['App\\Repository\\ElearningRepository'] = new \App\Repository\ElearningRepository(($container->services['doctrine'] ?? self::getDoctrineService($container)));
    }
}
