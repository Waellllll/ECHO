...
final class CommentController extends AbstractController
{
    ...
    #[Route('back/comment/{id}', name: 'app_commentback_delete', methods: ['POST'])]
    public function deleteback(Request $request, int $id, EntityManagerInterface $entityManager): Response
    {
        // Get the comment entity from the database
        $comment = $entityManager->getRepository(Comment::class)->find($id);
